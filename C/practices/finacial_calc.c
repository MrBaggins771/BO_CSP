...
int main(){
    ...
    printf("Your housing cost is %f which is %d % of your income.\n", housing_cost, housing_percent);
    printf("Your utility bill is %f which is %d % of your income.\n", utility_bill, utility_percent);
    printf("Your grocery bill is %f which is %d % of your income.\n", grocery_bill, grocery_percent);
    printf("Your transit cost is %f which is %d % of your income.\n", transit_cost, transit_percent);
    printf("You should save %f")
    return 0;
}